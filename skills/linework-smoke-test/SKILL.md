...
5. Restart the app and check Active again.

Expected result: Active quick-add creates a persisted unplanned active task. Not appearing in Today is expected until a Plan Today UI exists.
...
- no edit task UI
- no Plan Today action for existing Active tasks
...
- 3 Active Quick Add: Good / Not good / Details
